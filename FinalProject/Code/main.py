...
def main():
    # determine absolute root path dynamically using python's os library
    code_dir = os.path.dirname(os.path.abspath(__file__))
    root_dir = os.path.dirname(code_dir)
    
    # configure path references strictly matching your workspace template structure
    ...
    # --- STAGE 3: MATTING ---
    print("Stage 3: Alpha Matting & Compositing...")
    ...
    print("Stage 4: Particle Filter Tracking...")
    start_time = time.time()
    ...
    # export logged timings directly into timing.json inside Outputs directory
